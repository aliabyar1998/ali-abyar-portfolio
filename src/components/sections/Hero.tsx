      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center px-6 py-20">
        ...
        <div className="grid w-full gap-16 md:grid-cols-2 md:items-center">
          ...
          >
            ...
            <div className="flex flex-col items-center rounded-3xl border bg-card/80 p-8 shadow-2xl backdrop-blur">
              ...
              <p className="mt-2 text-center text-sm text-muted-foreground">
                ...
                International Trade & Data Analytics Specialist
              ...
              <div className="mt-8 flex w-full items-center gap-3 rounded-xl border bg-blue-500/5 p-4">
